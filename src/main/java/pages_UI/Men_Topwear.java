...
public class Men_Topwear 
{
	...
	@FindBy(xpath="//p[contains(text(),'FLAT ₹400 OFF')]") public static WebElement Offer;
	...
	@FindBy(xpath="//input[@class='desktop-searchBar']") public static WebElement SearchBar1; 
...
//		WebElement element = driver.findElement(SearchBar1);
//		return element;
//	}
	
	public Men_Topwear(WebDriver driver) {
		this.driver=driver;
